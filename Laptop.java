...
public class Laptop {
    ...
    @Override // переопределенный метод для лучшего отображения принтов в консоли
    public String toString() {
        return "module6.Laptop{" + "RAM=" + ram + " GB" + ", HDD=" + hdd + " GB" + ", OS='" + os + '\'' + ", Color='" + color + '\'' + '}';
    }

    @Override // переопределенный метод для коллекции set (что бы не было повторяющихся объектов)
